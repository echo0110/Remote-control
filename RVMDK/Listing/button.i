...
void button_init(void){
	...
	GPIO_InitStructure.GPIO_Pin   = ((uint16_t)0x0800) | ((uint16_t)0x1000) | ((uint16_t)0x2000) | ((uint16_t)0x4000) | ((uint16_t)0x8000);
	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_IPU;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);	
	
	GPIO_InitStructure.GPIO_Pin   = ((uint16_t)0x0040) | ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200);
	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_IPU;
	...
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), &GPIO_InitStructure);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0400));
	return;
}


#line 63 "..\\bsp_lib\\button.c"
...
void beep(u32 cnt){
	...
	while(cnt --){
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0400));
		delay(0x8FF);
		GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0400));
		delay(0x8FF);
	}
