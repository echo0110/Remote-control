...
#line 10 "..\\bsp_lib\\display.c"
#line 1 "..\\bsp_lib\\display.h"
...
#line 28 "..\\bsp_lib\\display.h"


#line 37 "..\\bsp_lib\\display.h"
...
#line 11 "..\\bsp_lib\\display.c"
#line 1 "..\\bsp_lib\\button.h"
...
void oled_show_line1_bmp(u8 index){
	...
	switch(index){
		case 0:
			OLED_DrawBMP((7*8), 0, (7*8)+16, 2, BmpSignal);
			break;
		case 1:
			OLED_DrawBMP((7*8), 0, (7*8)+16, 2, BmpNoSignal);
			break;		
		default:
			break;
	}
...
void oled_show_line2(u8 index, char chr){
	...
	switch(index){
		...
		case 3:
			...
			break;
		case 4:
			OLED_ShowCHinese(0,2,26);
			OLED_ShowCHinese(16,2,27);				
			break;
		case 5:
		...
		case 10:
			...
			OLED_ShowCHinese(16,2,41);	
			OLED_ShowCHinese(32,2,42);
			OLED_ShowCHinese(48,2,43);
			OLED_ShowCHinese(64,2,44);
			OLED_ShowCHinese(80,2,45);		
			break;
		case 6:
			if(10 == chr){
				x_pos = 0;
				...
				OLED_ShowChar(x_pos*8, 2, ' ');
				x_pos = x_pos>0 ? x_pos-1 : 0;
				OLED_ShowChar(x_pos*8, 2, '_');
			}else{
				if(12 == chr || 13 == chr){
					return;
				}
				chr += 0x30;
				OLED_ShowChar(x_pos*8, 2, chr);
				x_pos ++;
				OLED_ShowChar(x_pos*8, 2, '_');
			}
			break;
	...
	switch(index){
		...
		case 6:
			if(10 == chr){
				...
				OLED_ShowChar(x_pos*8, 4, ' ');
				x_pos = x_pos>0 ? x_pos-1 : 0;
				OLED_ShowChar(x_pos*8, 4, '_');
			}else{
				chr = 13 == chr ? ':' : chr+0x30;
				if(x_pos<19){
					OLED_ShowChar(x_pos*8, 4, chr);
					x_pos ++;
					OLED_ShowChar(x_pos*8, 4, '_');
				}
			}
