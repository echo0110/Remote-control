...
#line 22 "..\\bsp_lib\\oled.c"
#line 1 "..\\bsp_lib\\oledfont.h"
...
unsigned char BmpSignal[] = {0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0xF0,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,
0xF0,0xF0,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00};

unsigned char BmpNoSignal[] = {0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0xF0,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,
0xF0,0xF0,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0x88,0x50,0x20,0x50,0x88};




#line 23 "..\\bsp_lib\\oled.c"
...
{	
	...
	for(i=0;i<8;i++)
	{			  
		GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0008));
		if(dat&0x80)
		...
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0008));
		dat<<=1;   
	}				 		  
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0040));
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001));   	  
} 
...
{ 	 	 
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0004)|((uint16_t)0x0008));
