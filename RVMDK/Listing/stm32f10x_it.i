...
static key_t key[14] = {{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0040),   0,     0,      1,       2},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0080),   0,     0,      1,       5},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0100),   0,     0,      1,       8},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0200),   0,     0,      1,       0},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0100),   0,     0,      1,       11},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0200),   0,     0,      1,       9},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0400),  0,     0,      1,       6},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0800),  0,     0,      1,       3},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x1000),  0,     0,      1,       13},
                        {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0800),  0,     0,      1,       12},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x1000),  0,     0,      1,       1},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x2000),  0,     0,      1,       4},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x4000),  0,     0,      1,       7},
												{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x8000),  0,     0,      1,       10},
												 };
...
void EXTI9_5_IRQHandler(void)
{
	...
	EXTI_ClearITPendingBit(((uint32_t)0x00020) | ((uint32_t)0x00040) | ((uint32_t)0x00080) | ((uint32_t)0x00100) | ((uint32_t)0x00200) | ((uint32_t)0x00400));
	return;
}

void EXTI15_10_IRQHandler(void)
{
#line 287 "..\\User\\stm32f10x_it.c"
	EXTI_ClearITPendingBit(((uint32_t)0x00400) | ((uint32_t)0x00800) | ((uint32_t)0x01000) | ((uint32_t)0x02000) | ((uint32_t)0x04000) | ((uint32_t)0x08000));
	return;
}
