...
void display_by_key(int key, struct FSM *me){
	...
	if((LINK_START != me->status) && (key == 12)){
		oled_clear_line(2);
		oled_clear_line(4);
		if(fun_flag == 1){
			oled_show_line1(0, "N");
	...
	if(LINK_CONNECTED == me->status){
		if(1 == fun_flag){
			...
			switch(key){
				case 0:
					oled_show_line2(2, key);
					break;	
				case 1:
					oled_show_line2(3, key);
					break;				
				case 2:
					oled_show_line2(4, key);
					break;				
				case 3:
					oled_show_line2(5, key);
					break;				
				case 4:
					oled_show_line2(7, key);
					break;				
				case 5:
					oled_show_line2(8, key);
					break;				
				case 6:
					oled_show_line2(9, key);
					break;
				
				case 7:
					oled_show_line2(10, key);
					break;
